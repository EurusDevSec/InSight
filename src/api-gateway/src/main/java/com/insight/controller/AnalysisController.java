...
public class AnalysisController {
     ...
     * @param foodId          Nutrition DB food ID (e.g. "vn_com_trang", "vn_pho_bo")
    ...
    public ResponseEntity<Map<String, Object>> analyze(
            ...
            @RequestParam(value = "diabetes_type", required = false,
                    defaultValue = "type_2") String diabetesType,
            ...
            @RequestParam(value = "target_glucose", required = false,
                    defaultValue = "120") Double targetGlucose
    ) throws IOException {
