...
async def estimate_volume(
    ...
    try:
        ...
        return VolumeEstimationResponse(
            ...
            carb_range_low=vol_result.carb_range_low,
            carb_range_high=vol_result.carb_range_high,
            gl_range_low=vol_result.gl_range_low,
            gl_range_high=vol_result.gl_range_high,
            confidence_pct=vol_result.confidence_pct,
